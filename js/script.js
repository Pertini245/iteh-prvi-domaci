$(document).ready(function () {
    ...
    $('.broj').change(function (e) {
        ...
        if ($(this).val() < 1 || $(this).val() > 48) {
            alert('Brojevi moraju biti izmedju 1 i 48.');
            ucitajBrojeve();
            return;
        }
        $.ajax({
            type: "POST",
            url: "http://localhost/lucky-six/api/izmeni_ili_dodaj_izabrani.php",
            data: {
                id: $(this).attr('id'),
                noviBroj: $(this).val()
            },
    ...
    function ucitajBrojeve() {
        $.ajax({
            type: "GET",
            url: "http://localhost/lucky-six/api/vrati_izabrane.php",
            dataType: "JSON",
            success: function (response) {
    ...
    $('body').on('click', '.obrisi', function () {
        $.ajax({
            type: "GET",
            url: "http://localhost/lucky-six/api/izbrisi_kolo.php?id_kolo=" + $(this).attr('id'),
            dataType: "text",
            success: function (response) {
                alert(response);
                ucitajKola();
    ...
    $('#generisi-kolo').click(function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "http://localhost/lucky-six/api/generisi_kolo.php",
            data: {
                naziv: $('#naziv').val(),
    ...
    function ucitajKola() {
        $.ajax({
            type: "GET",
            url: "http://localhost/lucky-six/api/vrati_kola.php",
            dataType: "JSON",
            success: function (response) {
